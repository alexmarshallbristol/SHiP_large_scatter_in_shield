...
print('Z',muon_scattering_history_pre_scatter[0][1][3])

print(np.shape(muon_scattering_history_pre_scatter))
np.save('muon_scattering_history_pre_scatter',muon_scattering_history_pre_scatter)
...
# for i in range(0, np.shape(muon_kinematics_at_plane)[0]):
# 	# print(i)
