...
Double_t r = 5 + 0.8 * gRandom->Gaus();
  ...
  // cpg->AddTrack(fPdgCode,fPx,fPy,fPz,fStartX+dx,fStartY+dy,fStartZ+2228.5,-1,true,0,0,fW);
     cpg->AddTrack(fPdgCode,fPx,fPy,fPz,fStartX+dx,fStartY+dy,fStartZ+216+2012.60029,-1,true,0,0,fW);
