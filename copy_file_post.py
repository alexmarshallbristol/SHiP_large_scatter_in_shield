...
command = 'cp ship.conical.MuonBack-TGeant4_rec.root /eos/experiment/ship/user/amarshal/Scatter_FairShip/Scatter_ship.conical.MuonBack-TGeant4_rec_%s.root'%list_of_file_ID[jobid]
